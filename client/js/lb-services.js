...
/**
 * @ngdoc object
 * @name lbServices.LineItem
 * @header lbServices.LineItem
 * @object
 *
 * @description
 *
 * A $resource object for interacting with the `LineItem` model.
 *
 * ## Example
 *
 * See
 ...
 */
  module.factory(
    ...
    [
      ...
      function(LoopBackResource, LoopBackAuth, $injector, $q) {
        var R = LoopBackResource(
        urlBase + "/LineItems/:id",
          { 'id': '@id' },
          {

            // INTERNAL. Use LineItem.Order() instead.
            "prototype$__get__Order": {
              url: urlBase + "/LineItems/:id/Order",
              method: "GET",
            },

            /**
             * @ngdoc method
             * @name lbServices.LineItem#create
             * @methodOf lbServices.LineItem
             *
             * @description
             *
             * Create a new instance of the model and persist it into the data source.
             ...
             * <em>
             * (The remote method definition does not provide any description.
             * This usually means the response is a `LineItem` object.)
             * </em>
             */
            "create": {
              url: urlBase + "/LineItems",
              method: "POST",
            },

            /**
             * @ngdoc method
             * @name lbServices.LineItem#createMany
             * @methodOf lbServices.LineItem
             *
             * @description
             *
            ...
            /**
             * @ngdoc method
             * @name lbServices.LineItem#upsert
             * @methodOf lbServices.LineItem
             *
             * @description
             *
            ...
            /**
             * @ngdoc method
             * @name lbServices.LineItem#replaceOrCreate
             * @methodOf lbServices.LineItem
             *
             * @description
             *
             ...
             */
            "replaceOrCreate": {
              url: urlBase + "/LineItems/replaceOrCreate",
              method: "POST",
            },

            /**
             * @ngdoc method
             * @name lbServices.LineItem#upsertWithWhere
             * @methodOf lbServices.LineItem
             *
             * @description
             *
             ...
             */
            "upsertWithWhere": {
              url: urlBase + "/LineItems/upsertWithWhere",
              method: "POST",
            },

            /**
             * @ngdoc method
             * @name lbServices.LineItem#exists
             * @methodOf lbServices.LineItem
             *
             * @description
             *
             ...
             */
            "exists": {
              url: urlBase + "/LineItems/:id/exists",
              method: "GET",
            },

            /**
             * @ngdoc method
             * @name lbServices.LineItem#findById
             * @methodOf lbServices.LineItem
             *
             * @description
             *
             ...
             */
            "findById": {
              url: urlBase + "/LineItems/:id",
              method: "GET",
            },

            /**
             * @ngdoc method
             * @name lbServices.LineItem#replaceById
             * @methodOf lbServices.LineItem
             *
             * @description
             *
             ...
             */
            "replaceById": {
              url: urlBase + "/LineItems/:id/replace",
              method: "POST",
            },

            /**
             * @ngdoc method
             * @name lbServices.LineItem#find
             * @methodOf lbServices.LineItem
             *
             * @description
             *
            ...
            /**
             * @ngdoc method
             * @name lbServices.LineItem#findOne
             * @methodOf lbServices.LineItem
             *
             * @description
             *
             ...
             */
            "findOne": {
              url: urlBase + "/LineItems/findOne",
              method: "GET",
            },

            /**
             * @ngdoc method
             * @name lbServices.LineItem#updateAll
             * @methodOf lbServices.LineItem
             *
             * @description
             *
             ...
             */
            "updateAll": {
              url: urlBase + "/LineItems/update",
              method: "POST",
            },

            /**
             * @ngdoc method
             * @name lbServices.LineItem#deleteById
             * @methodOf lbServices.LineItem
             *
             * @description
             *
            ...
            /**
             * @ngdoc method
             * @name lbServices.LineItem#count
             * @methodOf lbServices.LineItem
             *
             * @description
             *
             ...
             */
            "count": {
              url: urlBase + "/LineItems/count",
              method: "GET",
            },

            /**
             * @ngdoc method
             * @name lbServices.LineItem#prototype$updateAttributes
             * @methodOf lbServices.LineItem
             *
             * @description
             *
            ...
            /**
             * @ngdoc method
             * @name lbServices.LineItem#createChangeStream
             * @methodOf lbServices.LineItem
             *
             * @description
             *
             ...
             */
            "createChangeStream": {
              url: urlBase + "/LineItems/change-stream",
              method: "POST",
            },
            ...
            // INTERNAL. Use Product.LineItem() instead.
            "::get::Product::LineItem": {
              url: urlBase + "/Products/:id/LineItem",
              method: "GET",
            },
          }
        );
            ...
            /**
             * @ngdoc method
             * @name lbServices.LineItem#patchOrCreate
             * @methodOf lbServices.LineItem
             *
             * @description
             *
        ...
        R["patchOrCreate"] = R["upsert"];
            ...
            /**
             * @ngdoc method
             * @name lbServices.LineItem#updateOrCreate
             * @methodOf lbServices.LineItem
             *
             * @description
             *
        ...
        R["updateOrCreate"] = R["upsert"];
            ...
            /**
             * @ngdoc method
             * @name lbServices.LineItem#patchOrCreateWithWhere
             * @methodOf lbServices.LineItem
             *
             * @description
             *
        ...
        R["patchOrCreateWithWhere"] = R["upsertWithWhere"];
            ...
            /**
             * @ngdoc method
             * @name lbServices.LineItem#update
             * @methodOf lbServices.LineItem
             *
             * @description
             *
        ...
        R["update"] = R["updateAll"];
            ...
            /**
             * @ngdoc method
             * @name lbServices.LineItem#destroyById
             * @methodOf lbServices.LineItem
             *
             * @description
             *
        ...
        R["destroyById"] = R["deleteById"];
            ...
            /**
             * @ngdoc method
             * @name lbServices.LineItem#removeById
             * @methodOf lbServices.LineItem
             *
             * @description
             *
        ...
        R["removeById"] = R["deleteById"];
            ...
            /**
             * @ngdoc method
             * @name lbServices.LineItem#patchAttributes
             * @methodOf lbServices.LineItem
             *
             * @description
             *
        ...
        /**
        * @ngdoc property
        * @name lbServices.LineItem#modelName
        * @propertyOf lbServices.LineItem
        * @description
        * The name of the model represented by this $resource,
        * i.e. `LineItem`.
        */
        R.modelName = "LineItem";


            /**
             * @ngdoc method
             * @name lbServices.LineItem#Order
             * @methodOf lbServices.LineItem
             *
             * @description
             *
             ...
             */
        R.Order = function() {
          var TargetResource = $injector.get("LineItem");
          var action = TargetResource["::get::LineItem::Order"];
      ...
      function(LoopBackResource, LoopBackAuth, $injector, $q) {
        ...
        */
        R.modelName = "Product";
            ...
            /**
             * @ngdoc method
             * @name lbServices.Product#LineItem
             * @methodOf lbServices.Product
             *
             * @description
             *
        ...
        R.LineItem = function() {
          var TargetResource = $injector.get("LineItem");
          var action = TargetResource["::get::Product::LineItem"];
          return action.apply(R, arguments);
        };
